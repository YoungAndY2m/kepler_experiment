...
# def delete_outputs_folder(base_dir, query_id, method):
#     """
#     Deletes the 'outputs' folder at the specified path:
#     {base_dir}/{query_id}/{method}/outputs.
#     """
#     # Construct the folder path
#     folder_path = os.path.join(base_dir, query_id, method, 'outputs')
...
# if __name__ == "__main__":
#     methods = ['cardinality', 'csv', 'kepler']
#     query_ids = ['3-0', '4-0', '6-0', '8-0', '9-0', '10-0', '11-0', '12-0', '13-0']
    
#     base_dir = "."
#     for query_id in query_ids:
#         for method in methods:
#             delete_outputs_folder(base_dir, query_id, method)
